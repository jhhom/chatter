...
export default function Page() {
  return (
    <div className="flex h-screen">
      <div className="w-[22rem] bg-gray-100"></div>
      <div className="w-[calc(100vw-22rem)]">
        <Conversation
          headerInfo={{
            ...
            online: true,
            lastSeen: new Date(),
            typing: "Jeremy howard",
            profilePhotoUrl:
              "https://upload.wikimedia.org/wikipedia/commons/thumb/5/52/Jeremy_Howard.jpg/440px-Jeremy_Howard.jpg",
            type: "p2p",
          }}
        />
      </div>
...
function Conversation(props: { headerInfo: ChatHeaderProps }) {
  return (
...
function DummyView() {
  return (
    <div className="flex h-full w-full items-center justify-center">
      <ChatIcon className="ml-2 h-20 w-20 text-primary-500" />
