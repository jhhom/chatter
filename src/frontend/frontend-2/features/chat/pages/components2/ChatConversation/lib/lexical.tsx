...
const MATCHERS = [
  (text: string) => {
    ...
    return {
      ...
      attributes: fullMatch.includes(`${config.BASE_URL}?join_group`) // check if it is a special link to join a group, if it is, we don't want to open a new tab when user open the link
        ? undefined
