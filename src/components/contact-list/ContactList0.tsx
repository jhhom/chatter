...
export function Contact2(
  ...
  return (
    <div
      className="flex cursor-pointer rounded-md py-2 hover:bg-primary-50"
    ...
    >
      ...
      <div className="flex w-[calc(100%-4rem-2rem)] items-center  pr-4">
        <div className="w-full">
          <div className="flex w-full items-end justify-between">
            <p>{props.fullname}</p>
            <p
              className={clsx("mb-0.5 text-xs", {
                "text-primary-600": 0 != 0,
                "text-gray-400": 0 === 0,
              })}
            >
              9:37 Pm
          ...
          <div className="flex h-[1.4rem] w-full items-end justify-between">
            {match(undefined)
              .when(
                () => props.type == "p2p" && props.isTyping,
                () => <p>{props.fullname} is typing...</p>
              )
              .when(
                () => props.type == "grp" && props.typingUserFullname,
                () => (
                  <p>
                    {props.type == "grp" && props.typingUserFullname} is
                    typing...
                  </p>
                )
              )
              .when(
                () =>
                  props.lastMessage !== null && props.lastMessage !== undefined,
                () => (
                  <p className="w-full overflow-hidden text-ellipsis whitespace-nowrap pr-2 text-sm text-gray-500">
                    {props.lastMessage?.type === "message"
